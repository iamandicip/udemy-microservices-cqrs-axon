...
public class UserLookupController {
    ...
    public ResponseEntity<UserLookupResponse> getAllUsers() {
        try {
            ...
            var response = queryGateway
                    .query(query, ResponseTypes.instanceOf(UserLookupResponse.class)).join();
    ...
    public ResponseEntity<UserLookupResponse> getUserById(@PathVariable(name = "id") String id) {
        try {
    ...
    public ResponseEntity<UserLookupResponse> searchUsersByFilter(@PathVariable(name = "filter") String filter) {
        try {
